            ...
            <footer>
                <div className="container py-5">
                    <div className="row justify-content-between">
                        ...
                        <div className="col-lg-2 offset-lg-1 col-sm-12 col-12">
                            <h5 className='text-white'>MAP</h5>
                            <Iframe url="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d56493.00710122838!2d85.359429!3d27.753915!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2snp!4v1690702423146!5m2!1sen!2snp" width="270" height="140" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                                id=""
                                className=" map"
                                display="block"
                                position="relative" />
